...
u8 MGPIO_u8GetPinValue(u8 Copy_u8PortName, u8 Copy_u8PinNumber)
{
	u8 Local_u8CopyPinValue = 0;
		switch (Copy_u8PortName)
		{
			case MGPIOA_PORT:Local_u8CopyPinValue =   READ_BIT(MGPIOA->IDR,Copy_u8PinNumber);	break;
			case MGPIOB_PORT:Local_u8CopyPinValue =   READ_BIT(MGPIOB->IDR,Copy_u8PinNumber);	break;
			case MGPIOC_PORT:Local_u8CopyPinValue =   READ_BIT(MGPIOC->IDR,Copy_u8PinNumber);	break;
			default: ;
		}
